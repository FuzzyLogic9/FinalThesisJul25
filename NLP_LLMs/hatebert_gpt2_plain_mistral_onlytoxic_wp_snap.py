...
# ==================== DEVICE SETUP (GPU ONLY) ====================
if not torch.cuda.is_available():
    raise RuntimeError("❌ No CUDA-capable GPU detected. Exiting (CPU is too slow for this job).")

device = torch.device("cuda")
gpu_name = torch.cuda.get_device_name(0)
gpu_vram = round(torch.cuda.get_device_properties(0).total_memory / 1024**3, 2)
print(f"✅ Using GPU: {gpu_name} ({gpu_vram} GB VRAM)")
...
# ==================== MISTRAL SETUP ====================
mistral_path = "C:/Users/fzkar/Main_Thesis_Experiments/NLP_LLMs/LLM_Libraries/Mistral-7B-v0.1"
...
mistral_model = AutoModelForCausalLM.from_pretrained(
    ...
    device_map="auto"   # spreads across GPU/CPU if VRAM is limited
)
mistral_model.eval()
torch.cuda.empty_cache()

# ==================== HATEBERT SETUP ====================
hatebert_path = Path("C:/Users/fzkar/Main_Thesis_Experiments/NLP_LLMs/LLM_Libraries/hatebert_finetuned")

hatebert_tokenizer = AutoTokenizer.from_pretrained(hatebert_path, local_files_only=True)
...
base_path = "C:/Users/fzkar/Main_Thesis_Experiments/NLP_LLMs/GPT_in/"
...
base_path_out = "C:/Users/fzkar/Main_Thesis_Experiments/NLP_LLMs/GPT_out/Mistral/MISTRAL_Snap/"
text_only_toxic_file = base_path_out + "text_output_escalated_Mistral_snap_G1_OT.csv"
scores_only_toxic_file = base_path_out + "score_output_escalated_Mistral_snap_G1_OT.csv"
...
with open(base_path_out + "generation_summary_ot_snap.txt", "a", encoding="utf-8") as f:
